...
from tracardi.service.storage.mysql.mapping.system_entity_table_column_mapping import map_to_system_entity_table_column_table
...
class SystemEntityTableColumnService(TableService):
    async def load_all(self, search: str = None, limit: int = None, offset: int = None) -> SelectResult:
        return await self._load_all(
            ...
            limit,
            offset,
            order_by=SystemEntityTableColumnTable.column,
