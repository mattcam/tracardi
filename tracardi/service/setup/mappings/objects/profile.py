...
from tracardi.domain.merging_strategy import NESTED_DICT, LATEST_DATE, EARLIEST_DATE, OR, ADD, UNIQUE_EXTEND, AND
...
default_profile_properties: List[SystemEntityProperty] = [
    ...
    SystemEntityProperty(entity='profile', id='90b98e78-fb16-45ba-8691-081e06d1ca2b', property='ids', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='72da7d73-d22b-4dfa-bb54-cec669292e1f', property='metadata.time.insert', type='datetime', optional=True, default='NULL', merge_strategy=EARLIEST_DATE),
    SystemEntityProperty(entity='profile', id='80d5979a-7bb5-4768-9a79-02dc3c740244', property='metadata.time.create', type='datetime', optional=True, default='NULL', merge_strategy=EARLIEST_DATE),
    SystemEntityProperty(entity='profile', id='19ae8b3a-ef2e-4347-ba99-0b0e1c81f80d', property='metadata.time.update', type='datetime', optional=True, default='NULL', merge_strategy=LATEST_DATE),
    ...
    SystemEntityProperty(entity='profile', id='e64fe226-ab27-4c8c-9978-9f9f8310a3cd', property='metadata.time.visit.count', type='integer', optional=True, default='0', merge_strategy=ADD),
    SystemEntityProperty(entity='profile', id='8f682e20-04ff-48da-9f7c-141c614d9b91', property='metadata.time.visit.current', type='datetime', optional=True, default=None, merge_strategy=LATEST_DATE),
    SystemEntityProperty(entity='profile', id='61d9747e-090a-4a76-b902-f462230d21a8', property='metadata.time.visit.last', type='datetime', optional=True, default=None, merge_strategy=LATEST_DATE),
    SystemEntityProperty(entity='profile', id='d7026962-5828-47a6-9f9d-bb276d80a324', property='metadata.time.segmentation', type='datetime', optional=True, default=None, merge_strategy=LATEST_DATE),
    SystemEntityProperty(entity='profile', id='d20af14d-bb6f-44b8-a41f-040aca7842fc', property='operation.new', type='bool', optional=True, default='False', merge_strategy=OR),
    SystemEntityProperty(entity='profile', id='16511736-2413-4f5a-9c5c-7db6ad8aa390', property='operation.update', type='bool', optional=True, default='False', merge_strategy=OR),
    SystemEntityProperty(entity='profile', id='cec510f0-d4e9-4061-bb21-e92aaa8f10cd', property='stats.visits', type='integer', optional=True, default='0', merge_strategy=ADD),
    SystemEntityProperty(entity='profile', id='68be2a45-f71e-4416-923e-2544f6af727d', property='stats.views', type='integer', optional=False, default='0', merge_strategy=ADD),
    SystemEntityProperty(entity='profile', id='4e2606f4-06a4-4449-8335-4290042835a6', property='stats.counters', type='dict', optional=False, default='{}', merge_strategy=NESTED_DICT),
    SystemEntityProperty(entity='profile', id='d28cd5bb-6390-4b41-97b4-d0d1818c1e75', property='traits', type='dict', optional=True, default='{}', merge_strategy=NESTED_DICT),
    SystemEntityProperty(entity='profile', id='73bc2894-0164-40b0-9684-8492c1ab31ae', property='segments', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='4b7c196a-d546-4e82-b74a-7d4e0fe41ab1', property='interests', type='Dict[str, float]', optional=True, default='{}', merge_strategy=NESTED_DICT),
    SystemEntityProperty(entity='profile', id='ae3c5af2-9a38-4bd6-b89f-7cd242262edb', property='consents', type='Dict[str, ConsentRevoke]', optional=True, default='{}', merge_strategy=NESTED_DICT),
    SystemEntityProperty(entity='profile', id='72144715-de3b-4a2f-915b-77d745d73d7c', property='active', type='bool', optional=False, default='True', merge_strategy=AND),
    SystemEntityProperty(entity='profile', id='ef46fe0a-7f24-4757-a0e4-4dd23c432467', property='aux', type='dict', optional=True, default='{}', merge_strategy=NESTED_DICT),
    SystemEntityProperty(entity='profile', id='385e06a8-9204-4c72-8e45-bd12369d389c', property='data.anonymous', type='bool', optional=True, default='NULL', merge_strategy=OR),
    ...
    SystemEntityProperty(entity='profile', id='fb0606ed-f5e5-45d7-aeb3-9956b74c35cf', property='data.pii.language.spoken', type='List[str]', optional=True, default='NULL', merge_strategy=UNIQUE_EXTEND),
    ...
    SystemEntityProperty(entity='profile', id='6d051b80-347a-447c-be9f-75e878e380c4', property='data.identifier.coupons', type='List[str]', optional=True, default='NULL', merge_strategy=UNIQUE_EXTEND),
    ...
    SystemEntityProperty(entity='profile', id='db1f7f98-30fe-4082-beab-a816a43264f5', property='data.preferences.purchases', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='9ba0d923-e040-4a3c-b049-24d503abbbee', property='data.preferences.colors', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='567e7d26-5be2-43e0-9427-c10bc5f75044', property='data.preferences.sizes', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='07bab6d0-263c-4999-a5d2-205c88d3daae', property='data.preferences.devices', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='63b9bf46-6ad3-4ac1-ac98-fb0886a38aaa', property='data.preferences.channels', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='e96d6dc4-024b-4d44-a8ef-e20a38aed394', property='data.preferences.payments', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='ccc7f7b4-856f-46e3-aacb-d9c8437aa218', property='data.preferences.brands', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='d0c96de4-67a7-4cc2-952d-596eede1d695', property='data.preferences.fragrances', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='80181d7d-99e4-4fb7-9c5b-81d537a41390', property='data.preferences.services', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='b58c4484-2900-4de4-9c78-884053c1502e', property='data.preferences.other', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    ...
    SystemEntityProperty(entity='profile', id='7859ff38-c4fd-4dd4-a051-a9ed725bdf38', property='data.job.company.segment', type='List[str]', optional=True, default='NULL', merge_strategy=UNIQUE_EXTEND),
    ...
    SystemEntityProperty(entity='profile', id='7272384a-765a-4ec7-a92c-8eaa196f0d4c', property='data.loyalty.codes', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    ...
    SystemEntityProperty(entity='profile', id='5979d815-2f76-4753-806b-a4d58de73863', property='data.devices.push', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    SystemEntityProperty(entity='profile', id='d14f5de6-90be-498e-93ed-bf8d63d98ca1', property='data.devices.other', type='List[str]', optional=True, default='[]', merge_strategy=UNIQUE_EXTEND),
    ...
    SystemEntityProperty(entity='profile', id='6b79adb3-d76b-438c-9bbb-fafca580647b', property='data.contact.confirmations', type='List[str]', optional=True, default=None, merge_strategy=UNIQUE_EXTEND),
